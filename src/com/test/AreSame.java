 ...
 *         Examples
 *
 *         Valid arrays a = [121, 144, 19, 161, 19, 144, 19, 11] b = [121,
 *         14641, 20736, 361, 25921, 361, 20736, 361] comp(a, b) returns true
 *         because in b 121 is the square of 11, 14641 is the square of 121,
 ...
 *         144*144, 19*19, 161*161, 19*19, 144*144, 19*19] Invalid arrays If we
 *         change the first number to something else, comp may not return true
 *         anymore:
 *
 *         a = [121, 144, 19, 161, 19, 144, 19, 11] b = [132, 14641, 20736, 361,
 *         25921, 361, 20736, 361] comp(a,b) returns false because in b 132 is
 *         not the square of any number of a.
 *
 ...
 *
 *         Remarks a or b might be [] (all languages except R, Shell). a or b
 *         might be nil or null or None or nothing (except in Haskell, Elixir,
 *         C++, Rust, R, Shell).
 *
...
public class AreSame {
	...
	public static boolean comp(int[] a, int[] b) {
		...
		// sorting both array for comparing
		a = sorting(a);
		b = sorting(b);

		for (int i = 0; i < a.length; i++) {
			if (Math.abs(a[i]) != Math.sqrt(b[i])) {
				return false;
			}
		}
