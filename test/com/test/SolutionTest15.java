...
public class SolutionTest15 {  
    ...
    public void shouldWorkWithNoMoves() {
      ...
      assertEquals(solution, Solution15.streetFighterSelection(fighters, new int[]{0,0}, new String[]{}));
    }
    ...
    public void shouldWorkWithFewMoves(){
      ...
      assertEquals(solution, Solution15.streetFighterSelection(fighters, new int[] {0,0}, moves));
    }
